        ...
        <>
            ...
            >
                ...
                <div className="flex flex-1 flex-col justify-between">
                    <span>
                        <h2 className="text-xl font-bold line-clamp-2 leading-6 capitalize mb-2">
                            {title}
                        </h2>
                        <p className="text-l pb-2 font-semibold capitalize">
                            {getUser?.username}
                        </p>
                    </span>
                    <div
                    ...
                    <div className="flex-end">
                        <p className="text-l text-gray-600 mt-2 align-text-bottom">
                            Posted on:{" "}
